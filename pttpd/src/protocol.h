...
// a resource is made up of
// a.   its identifier (the public key)
// b.   a path to the resource contents in the local filesystem
// c.   the current content signature which is generated from a
//      data hash and the private key; this means it can only be
//      generated by the original author, but verified by anyone
